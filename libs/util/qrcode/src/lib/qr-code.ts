...
import { stringToBytes_SJIS } from './text/string-to-bytes_sjis'
import { GIFImage } from './image/gif-image'

import { ErrorCorrectLevel } from './error-correct-level'
import { QRData } from './qr-data'
// import { QR8BitByte } from './qr-8bit-byte'
...
export class QRCode {
  ...
  public static createData(
    ...
    var rsBlocks: RSBlock[] = RSBlock.getRSBlocks(typeNumber, errorCorrectLevel)
